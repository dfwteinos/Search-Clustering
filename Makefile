...
gdblsh: main arguments util hash_functions hash_tables lsh_functions cube_functions cluster_functions
	g++ -g3 -o lsh arguments.o hash_functions.o util.o main.o hash_tables.o	lsh_functions.o cube_functions.o cluster_functions.o && gdb --args lsh -d train-images-idx3-ubyte -q t10k-images-idx3-ubyte -o output.txt
...
vallsh: main arguments util hash_functions hash_tables lsh_functions cube_functions cluster_functions
	g++ -o lsh arguments.o hash_functions.o util.o main.o hash_tables.o lsh_functions.o cube_functions.o cluster_functions.o && valgrind ./lsh -d train-images-idx3-ubyte -q t10k-images-idx3-ubyte -o output.txt

valcube: main arguments util hash_functions hash_tables lsh_functions cube_functions cluster_functions
	g++ -o cube arguments.o hash_functions.o util.o main.o hash_tables.o lsh_functions.o cube_functions.o cluster_functions.o && valgrind ./cube -d train-images-idx3-ubyte -q t10k-images-idx3-ubyte -o output.txt
